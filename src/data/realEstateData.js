// 数据来源：国家统计局70城房价指数 + 各地房产交易中心公开数据
// 价格为二手住宅参考均价（元/㎡），趋势基于NBS月度环比指数推算
// 更新周期：每月15日前后（统计局发布上月数据）
// 免责：本数据仅供参考，非实时成交价，投资需以官方及专业机构数据为准

export const DATA_SOURCE = "国家统计局70城房价指数";
export const DATA_DATE = "2025年2月";
